...
var addNoteBtn = document.getElementById('btn-add-note'); // event listeners
...
notesContainer.addEventListener('click', function (e) {
  switch (e.target.localName) {
    case 'input':
      toggleNote(e.target.parentNode.childNodes.item(1) //pNode only
      );
      break;

    case 'p':
      console.log(e.target.parentNode.childNodes);
      toggleNote(e.target.parentNode.childNodes.item(1), // pNode
...
function addNote(noteBody) {
  console.log('add note'); // create new note item

  var noteItem = document.createElement('div');
  noteItem.classList = 'note-item noselect';
  var noteLeft = document.createElement('div');
  noteLeft.classList = 'note-left';
  var noteRight = document.createElement('div');
  ...
  noteItem.appendChild(noteRight); // add new noteItem object to notes container

  notesContainer.appendChild(noteItem);
}

function toggleNote(pNode) {
  var inputNode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  // cross out text and check box
  pNode.classList.toggle('checked');
  if (inputNode) inputNode.checked ^= 1;
}

function deleteNote(parentNode) {
  console.log('delete note');
  parentNode.style.display = 'none'; //parentNode.removeChild(1);
}
...
},{"./components/notes":"components/notes.js"}],"../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/jacob-dashboard.e31bb0bc.js.map